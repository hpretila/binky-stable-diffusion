...
from util.typing import from_str, to_class, from_stringified_bool
...
class DiffusionConfig:
    ...
    def from_dict(obj: Any) -> 'DiffusionConfig':
        ...
        pretrained_model_name_or_path = from_str(
            obj.get("pretrained_model_name_or_path"))
        ...
        train_text_encoder = from_stringified_bool(
            from_str(obj.get("train_text_encoder")))
        use_xformers = from_stringified_bool(obj.get("use_xformers"))
        return DiffusionConfig(pretrained_model_name_or_path, completed_model_path, revision, config_vae, config_unet, config_scheduler, train_vae, train_unet, train_text_encoder, use_xformers)

    def to_dict(self) -> dict:
        result: dict = {}
        result["pretrained_model_name_or_path"] = from_str(
        ...
        result["train_text_encoder"] = from_str(
            str(self.train_text_encoder).lower())
        result["use_xformers"] = from_str(
            str(self.use_xformers).lower())
        return result
